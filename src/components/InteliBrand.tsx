  ...
  return (
    <div className={`inline-flex items-center gap-3 ${className}`}>
      ...
      >
        ...
        {/* 'e' - Refatorado conforme padrão geométrico Brandbook Inteli 2025 */}
        <path
          d="M141.5 63.2C138.2 69.2 132.2 72.5 124.8 72.5C114.2 72.5 106.5 64.8 106.5 55C106.5 45.2 114.2 37.5 124.8 37.5C135.2 37.5 142.5 45.2 142.5 56.2V57.5H113.8C114.2 63 118.2 66.5 124.8 66.5C129.2 66.5 132.8 64.5 135.2 61.2L141.5 63.2ZM113.8 51.5H135.5C135 46.2 130.8 43.5 124.8 43.5C118.8 43.5 114.5 46.2 113.8 51.5Z"
          fill={textColor}
        />
